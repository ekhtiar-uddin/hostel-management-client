const Description = () => {
  return (
    <div className="addFlexJustify py-16 ">
      <p className=" w-[600px] text-center  font-medium">
        ...
        quick coffee and breakfast sandwich, you’ll find a variety of menu
        options to fill every craving.
      </p>
    </div>
  );
};
